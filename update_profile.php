   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <span>barangay:</span>
            <input type="text" name="update_homeaddress" value="<?php echo $fetch['barangay']; ?>" class="box">
            <span>province:</span>
            <input type="text" name="update_homeaddress" value="<?php echo $fetch['province']; ?>" class="box">
            <span>municipality/city:</span>
            <input type="text" name="update_homeaddress" value="<?php echo $fetch['municipality']; ?>" class="box">
            <span>Zip code:</span>
            <input type="text" name="update_homeaddress" value="<?php echo $fetch['zipcode']; ?>" class="box">
         </div>
      </div>
